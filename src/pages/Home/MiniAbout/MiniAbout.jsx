...
const MiniAbout = ({ title, description, image, reverse = false }) => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${
          ...
          <motion.div 
            ...
            className={`relative order-1 ${reverse ? "lg:order-2" : "lg:order-1"}`}
          >
            {/* Outer glow container */}
            <div className="relative p-1 rounded-3xl bg-gradient-to-br from-primary/30 via-secondary/30 to-accent/30">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className={`absolute -bottom-4 ${reverse ? "-left-4" : "-right-4"} w-24 h-24 rounded-2xl bg-gradient-to-br from-primary to-secondary p-1 shadow-2xl`}
            >
          ...
          >
            <div className="max-w-xl mx-auto">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="h-0.5 bg-gradient-to-r from-primary to-secondary mb-6"
              />
      ...
      >
        <div className="text-xs text-muted-foreground uppercase tracking-widest mb-2">Scroll</div>
        <motion.div
          animate={{ 
          ...
          className="w-px bg-gradient-to-b from-primary via-secondary to-transparent"
        />
      </motion.div>
    </motion.section>
  );
