        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="relative h-[400px] lg:h-[500px] overflow-hidden">
              ...
              <span className="absolute top-6 left-6 bg-white/90 backdrop-blur-md text-black 
            ...
            {/* Content Area */}
            <div className="p-8 lg:p-10 space-y-4 -mt-2"> {/* Negative margin to pull content up */}
